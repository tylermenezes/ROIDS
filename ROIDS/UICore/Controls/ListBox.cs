...
namespace UICore.Controls
{
    ...
    public class ListBox : Control
    {
        ...
        public ListBox(Vector2 location, string[] text, SpriteFont font, Color fontColor)
            : this(location,  text, font, fontColor, new Size())
        {
        ...
        void ListBox_MouseClick(GUIElement sender, MouseEventArgs e)
        {
            OnSelectionMade();
        }
        ...
        {
            _updateTime = time.TotalGameTime.Milliseconds;
            base.Update(time);
        }
        ...
        public override void Draw(Microsoft.Xna.Framework.GameTime time, Microsoft.Xna.Framework.Graphics.SpriteBatch spriteBatch)
        {
            ...
            // Highlight Selection
            spriteBatch.DrawString(Font, Text[SelectedItem],
